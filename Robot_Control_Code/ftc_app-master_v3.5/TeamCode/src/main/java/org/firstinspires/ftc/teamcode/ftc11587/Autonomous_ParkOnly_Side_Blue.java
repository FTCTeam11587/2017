...
@Autonomous(name="Auto_ParkOnly_Side_Blue", group="Relic Recovery")
//@Disabled

public class Autonomous_ParkOnly_Side_Blue extends LinearOpMode {
	...
	public void runOpMode() {
		...
		telemetry.addData("Status","Autonomous_ParkOnly_Side_Blue initialized.");
		telemetry.update();
		...
		while (opModeIsActive()) {
            ...
            /*Move to robot middle safe zone
			...
			lfMotor.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);	//TODO: may need to adjust motor direction based on Blue orientation
			lfMotor.setMode(DcMotor.RunMode.RUN_USING_ENCODER);
			lfMotor.setDirection(DcMotorSimple.Direction.FORWARD);
