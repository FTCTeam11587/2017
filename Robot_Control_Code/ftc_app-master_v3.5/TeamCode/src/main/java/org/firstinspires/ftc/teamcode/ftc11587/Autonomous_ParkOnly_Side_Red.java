...
@Autonomous(name="Auto_ParkOnly_Side_Red", group="Relic Recovery")
//@Disabled

public class Autonomous_ParkOnly_Side_Red extends LinearOpMode {
	...
	public void runOpMode() {
		...
		telemetry.addData("Status","Autonomous_ParkOnly_Side_Red initialized.");
		telemetry.update();
		...
		while (opModeIsActive()) {
			...
			*/
			...
			lfMotor.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);			//TODO: may need to adjust motor direction for Red orientation
			lfMotor.setMode(DcMotor.RunMode.RUN_USING_ENCODER);
			lfMotor.setDirection(DcMotorSimple.Direction.FORWARD);
