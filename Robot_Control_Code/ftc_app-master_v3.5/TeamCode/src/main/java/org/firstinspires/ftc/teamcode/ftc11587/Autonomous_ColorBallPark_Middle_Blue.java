...
@Autonomous(name="Auto_ColorBallPark_Middle_Blue", group="Relic Recovery")
//@Disabled

public class Autonomous_ColorBallPark_Middle_Blue extends LinearOpMode {
	...
	public void runOpMode() {
		...
		telemetry.addData("Status","Autonomous_ColorBallPark_Middle_Blue initialized.");
		telemetry.update();
