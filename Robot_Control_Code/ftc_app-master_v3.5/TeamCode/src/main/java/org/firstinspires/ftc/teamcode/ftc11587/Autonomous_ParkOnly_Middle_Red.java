...
@Autonomous(name="Auto_ParkOnly_Middle_Red", group="Relic Recovery")
//@Disabled

public class Autonomous_ParkOnly_Middle_Red extends LinearOpMode {
	...
	public void runOpMode() {
		...
		telemetry.addData("Status","Autonomous_ParkOnly_Middle_Red initialized.");
		telemetry.update();
